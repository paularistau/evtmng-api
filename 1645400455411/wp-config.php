...
define('WP_PLUGIN_URL', 'http://apieventmng.test/1645400455411/wp-content/plugins'); 
define('WP_LANG_DIR', __DIR__ . "/wp-content/languages"); 
define('WP_HOME', 'http://apieventmng.test/1645400455411'); 
define('WP_SITEURL', 'http://apieventmng.test/1645400455411'); 
